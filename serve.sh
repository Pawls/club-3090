...
declare -A INFO=(
  ...
  [38b-dual]=":8117  qwen3.8-27b (Unsloth UD-Q5_K_XL) · dual · 262K alloc / 240K FILLED (91%, ladder 6/6) · ⭐ VISION · MTP n=2 (accept 0.686) · verify-full 9/9 + verify-stress green · 🧪 no soak/bench/8-pack yet · ⚠ thinking ON + effort xhigh by DEFAULT (diverges from stack policy; unmeasured on 3.8) · INSTRUCT=1 for the instruct arm · per-request dials: enable_thinking / preserve_thinking / reasoning_effort"
